package ECommerceProject.googleAuthenticator;
...
public boolean register(int id, String firstName, String lastName, String email, String password) {
		...
		System.out.println("Üyelik iþleminin tamamlanmasý için lütfen mail adresinize gelen maili kontrol ediniz.(Google Ekibi)");
		return true;
	}
